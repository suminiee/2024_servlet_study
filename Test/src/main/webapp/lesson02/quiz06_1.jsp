...
<body>
	...
	%>
	<div class="container">
		<h1 class="text-center mt-2">검색 결과</h1>
			...
			<tbody>
				<%
					for (Map<String, Object> mapList : list) {
                    	String menu = (String) mapList.get("menu");
                    	if (menu.equals(foodName)) {
                    		//skip조건 : 체크가 되어있고, 4점 이하일 때
                    		if (exclude && (double)mapList.get("point") <= 4) {
                    			continue;
                    		}
				%>
				<tr>
